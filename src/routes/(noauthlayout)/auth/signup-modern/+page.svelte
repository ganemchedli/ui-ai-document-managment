...
<svelte:body use:classList={'font-public'} />
...
>
		...
		<div class="flex flex-col w-full h-full">
			...
			<div class="my-auto">
				<div class="lg:w-[20rem] mx-auto mt-10">
					<ul class="flex flex-wrap w-full gap-2 text-sm font-medium text-center nav-tabs">
						<li class="group grow {tabId == 'email' ? 'active' : ''}">
							<a
								...
								on:click={() => (tabId = 'email')}
								><LucideIcon name="Mail" class="inline-block size-4 mr-1" />
								<span class="align-middle">Email</span></a
							>
						</li>
						<li class="group grow {tabId == 'phone' ? 'active' : ''}">
							<a
								href={'javascript:void(0);'}
								class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]"
								on:click={() => (tabId = 'phone')}
								><LucideIcon name="Smartphone" class="inline-block size-4 mr-1" />
								<span class="align-middle">Phone</span></a
							>
						</li>
					</ul>
				</div>
				<div class="lg:w-[25rem] mx-auto">
					<div class="mt-5 tab-content">
						<div class="tab-pane {tabId == 'email' ? 'block' : 'hidden'}" id="emailLogin">
							<form action="/" class="mt-10" id="signInForm">
								<div
									class="hidden p-3 mb-3 text-base text-green-500 border border-green-200 rounded-md bg-green-50"
									id="successAlert"
								>
								...
								<div class="mb-3">
									...
									/>
									<div id="username-error" class="hidden mt-1 text-sm text-red-500">
						...
						<div class="tab-pane {tabId == 'phone' ? 'block' : 'hidden'}" id="phoneLogin">
							<form action="/" class="mt-10" id="signInForm">
								<div
								...
								<div class="mb-3">
									<label for="phoneNumber" class="inline-block mb-2 text-base font-medium"
										>Phone Number</label
									>
									<input
										type="number"
									...
									/>
									<div id="phone-error" class="hidden mt-1 text-sm text-red-500">
										Please enter a valid email address.
									</div>
								</div>
								<div class="mb-3">
					...
					<div class="flex flex-wrap justify-center gap-2">
						<button
							...
							><LucideIcon name="Facebook" class="size-4" /></button
						>
						<button
							type="button"
							...
							><LucideIcon name="Mail" class="size-4" /></button
						>
						<button
							type="button"
							...
							><LucideIcon name="Twitter" class="size-4" /></button
						>
						<button
							type="button"
							...
							><LucideIcon name="Github" class="size-4" /></button
						>
					</div>
			...
			<div class="mt-5">
				<p class="mb-0 text-center text-15 text-slate-500 dark:text-zink-200">
					©
					{new Date().getFullYear()} Tailwick. Crafted with <i class="text-red-500 ri-heart-fill" />
					by
					<a
						href="http://themesdesign.in"
						class="underline transition-all duration-200 ease-linear text-slate-800 dark:text-zink-50 hover:text-custom-500 dark:hover:text-custom-500"
						>Themesdesign</a
					>
				</p>
			</div>
	...
	<div
		class="relative z-10 flex items-center justify-center min-h-screen px-10 text-center grow py-14"
	>
		<div>
			<a href="#!"
				><img src="/assets/images/logo-light.png" alt="" class="block mx-auto mb-14 h-7" /></a
			>
			<img
				src="/assets/images/auth-modern.png"
				alt=""
				class="block object-cover mx-auto shadow-lg md:max-w-md rounded-xl shadow-custom-800"
			/>
			<div class="mt-10 text-center">
				<h3 class="mt-4 mb-3 capitalize text-custom-50">
					Tools for crafting your business's brand identity
				</h3>
				<p class="max-w-2xl text-custom-300 text-16">
					Unlock the potential of our versatile branding tools, designed to empower your business in
					shaping a distinctive and impactful brand. Elevate your business's image and leave a
					lasting impression with our comprehensive branding solutions.
				</p>
			</div>
		</div>
	</div>
