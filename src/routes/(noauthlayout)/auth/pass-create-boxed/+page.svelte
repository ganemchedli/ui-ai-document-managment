			...
			<div class="!px-12 !py-12 card-body h-full flex flex-col">
				<div class="my-auto">
					...
					<form autocomplete="off" action="/">
						<div class="mb-3">
							<label for="passwordInput" class="inline-block mb-2 text-base font-medium"
								>Password</label
							>
							<input
								type="password"
						...
						<div class="mb-3">
							<label for="passwordConfirmInput" class="inline-block mb-2 text-base font-medium"
						...
						<div class="mt-4 text-center">
							<p class="mb-0">
								Hold on, I've got my password... <a
