...
<svelte:body
	use:classList={'flex items-center justify-center min-h-screen py-16 bg-cover bg-auth-pattern dark:bg-auth-pattern-dark dark:text-zink-100 font-public'}
/>
	...
	<div class="!px-10 !py-12 card-body">
		...
		<form action="#!" class="mt-10" id="registerForm">
			...
			<p class="italic text-15 text-slate-500 dark:text-zink-200">
				By registering you agree to the Tailwick <a href="#!" class="underline">Terms of Use</a>
			</p>
			<div class="mt-10">
				<button
					type="submit"
