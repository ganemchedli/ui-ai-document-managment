...
module.exports = plugin(function ({ addComponents, theme }) {
    addComponents({
        ...
        '.flatpickr-months': {
            '@apply bg-transparent flex items-center h-12 !p-2': {},
            ...
            '.flatpickr-prev-month, .flatpickr-next-month': {
                '@apply text-slate-500 fill-slate-500 h-8 w-8 flex items-center hover:text-slate-600 dark:hover:text-zink-100 top-2 border border-slate-200 dark:border-zink-500 dark:fill-zink-100 rounded-md': {},
        ...
        '.flatpickr-day': {
            ...
            '&.today': {
                '@apply text-custom-50 bg-custom-500 border-custom-500 rounded-md': {},
                '&:hover, &:focus': {
